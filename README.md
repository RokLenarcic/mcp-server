...
The library is functional and actively used but still considered alpha. The following features from the MCP 2025-11-25 specification are **not yet implemented**:
...
Features carried forward from **2025-06-18**:

- Streamable HTTP transport (SSE) and stdio transport
- Tools with structured content and output schemas
- Prompts, Resources, Resource Templates
- Resource subscriptions and list-changed notifications
- Form-mode elicitation and sampling (server-to-client requests)
- Completions with context
- Pagination, progress, and cancellation
- Middleware and async execution
